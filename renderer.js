...
const VOICES = {
  gemini: [
    ['Puck', 'Puck - upbeat, best young male-style English'],
    ['Fenrir', 'Fenrir - energetic male-style'],
    ['Orus', 'Orus - firm male-style'],
    ['Charon', 'Charon - informative male-style'],
    ['Enceladus', 'Enceladus - breathy warm style'],
    ['Iapetus', 'Iapetus - clear style'],
    ['Leda', 'Leda - youthful style'],
    ['Achird', 'Achird - friendly style'],
    ['Zubenelgenubi', 'Zubenelgenubi - casual style'],
    ['Laomedeia', 'Laomedeia - upbeat style'],
    ['Algieba', 'Algieba - smooth style'],
    ['Algenib', 'Algenib - gravelly style'],
    ['Rasalgethi', 'Rasalgethi - informative style'],
    ['Alnilam', 'Alnilam - firm style'],
    ['Schedar', 'Schedar - even style'],
    ['Gacrux', 'Gacrux - mature style'],
    ['Sadaltager', 'Sadaltager - knowledgeable style'],
    ['Sulafat', 'Sulafat - warm style'],
    ['Aoede', 'Aoede - breezy female-style'],
    ['Kore', 'Kore - firm female-style'],
    ['Zephyr', 'Zephyr - bright female-style'],
    ['Callirrhoe', 'Callirrhoe - easy-going style'],
    ['Autonoe', 'Autonoe - bright style'],
    ['Umbriel', 'Umbriel - easy-going style'],
    ['Despina', 'Despina - smooth style'],
    ['Erinome', 'Erinome - clear style'],
    ['Achernar', 'Achernar - soft style'],
    ['Pulcherrima', 'Pulcherrima - forward style'],
